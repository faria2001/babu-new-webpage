                        ...
                        <div className="col-lg-6 col-md-12">
                            <div className="content_technology" data-aos="fade-up" data-aos-duration={800}>
                                <div className="tf-title left">
                                    ...
                                    Introducing Bubu the Bear!
                                    </h2>
                                    <h4 className="title mb20">
                                        the most endearing and lovable mascot the crypto world has ever seen!
                                    </h4>
                                </div>
                                <p className="sub_technology">Bubu started his journey as an ordinary forest dweller with an extraordinary love for honey, long naps, and the occasional adventure. One sunny afternoon, while exploring a particularly tech-savvy camper's backpack, Bubu accidentally activated a cryptocurrency app. With curiosity sparked by glowing screens and intriguing charts, Bubu's transformation from a simple forest bear into a crypto sensation began.
                                </p>
